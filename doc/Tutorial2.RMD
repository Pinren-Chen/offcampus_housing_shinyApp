...
```{r load_data}
mh2009=read.csv(file="/Users/linhan/Desktop/Fall2017-project2-grp6/data/ManhattanHousing.csv")
...
save(count.df, file="/Users/linhan/Desktop/Fall2017-project2-grp6/output/count.RData")
```
...
if (!require("choroplethrZip"))  
  devtools::install_github('arilamstein/choroplethrZip@v1.5.0', force=TRUE)
...
library(dplyr)
```
```{r geo_codes, message=F,warning=F}
  mh2009%>%
  sample_n(10)%>%
...
mh2009.use=
  ...
  arrange(bldg.type)
save(mh2009.use, file="/Users/linhan/Desktop/Fall2017-project2-grp6/output/mh2009use.RData")
```
